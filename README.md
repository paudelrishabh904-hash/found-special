...
<head>
    <title> Our Love Story re start will you be my Again patner 
                I will be as a good patner i promise my dear Miss Sandhya </title>
    ...
    <style type="text/css">
        ...
        #words{font-family:"sans-serif";width:505px;font-size:24px;color:#666}
    ...
    <!-- Using a reliable CDN for jQuery so it never gets cut off -->
            ...
            a.fn.typewriter=function(){
                this.each(function(){
                    ...
                    var e=setInterval(function(){
                        var f=c.substr(b,1);if(f=="<"){b=c.indexOf(">",b)+1}else{b++}d.html(c.substring(0,b)+(b&1?"_":""));if(b>=c.length){clearInterval(e)}
                    },75)
                });return this
            }
        })(jQuery);
    ...
    <div id="mainDiv">
        <div id="content">
            <div id="code">
                ...
                <span class="space"/><span class="comments">* We are studied at Nepal Adarsh since 9th class,</span><br />
                <span class="space"/><span class="comments">* I will prove how we will love each other.</span><br />
                <span class="space"/><span class="comments">*/</span><br />
                Boy i = <span class="keyword">new</span> Boy(<span class="string">"Your Naughty Rishabh"</span>);<br />
                Girl u = <span class="keyword">new</span> Girl(<span class="string">"Miss Sandhya"</span>);<br />
                <span class="comments">// April 2, 2026, I told you I love you. </span><br />
                i.love(u);<br />
            ...
            <div id="loveHeart">
                ...
                <div id="words">
                    <div id="messages">
                        Miss Sandhya, I will have fallen in love with you for
                        <div id="elapseClock" style="display:none"></div>
                        <a href='#' id="accept">click me if accept me</a>
                    </div>
                    <div id="loveu">
                        Love u forever and ever.<br/>
                        <div class="signature">- Your Naughty Rishabh</div>
                    </div>
                </div>
            </div>
        </div>
